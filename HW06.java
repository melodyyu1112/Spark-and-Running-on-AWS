...
public class HW6 {
  ...
  public static void main(String[] args) {
    ...
    //save to a text file, scroll down for code
  ...
  /* Q1. Select all flights that leave from Seattle, WA, and return the destination city names.
  ...
  /* Q2. Implement the same query as above, but use the RDD API.
  ...
  /* Q3. Find the number of non-cancelled flights per month that departs from each city,
  ...
  /* Q4. Find the name of the city that is connected to the most number of other cities with direct flights. 
         Return the result as a pair that consists of a String for the city name, and an Integer for the total number of flights (not cities) to the other cities.*/
 ...
 /* Q5. Compute the average delay from all departing flights for each city.
